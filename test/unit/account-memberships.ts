...
describe('ElasticPath Account Memberships', () => {
  ...
  it('Get a single account membership', () => {
    ...
    return ElasticPath.AccountMemberships.Get(
      accountId,
      accountMembershipId
    ).then(res => {
      assert.isObject(res)
  ...
  it('Get all Account Memberships for an account', () => {
    ...
    return ElasticPath.AccountMemberships.All(accountId).then(res => {
      assert.isObject(res)
    })
  })
  ...
  it('Get all Unassigned Account Members for an account', () => {
    ...
    return ElasticPath.AccountMembers.UnassignedAccountMembers(accountId).then(
      res => {
        assert.isObject(res)
      }
    )
  ...
  it('Get all Unassigned Account Members for an account with filter', () => {
    ...
    return ElasticPath.AccountMembers.Filter({ eq: { name: 'John' } })
      .UnassignedAccountMembers(accountId)
      .then(res => {
        assert.isObject(res)
      })
  })
  ...
  it('Get all Account Memberships for an account using limit', () => {
    ...
    return ElasticPath.AccountMemberships.Limit(3)
      .All(accountId)
      .then(res => {
  ...
  it('Create a single account membership', () => {
    ...
    return ElasticPath.AccountMemberships.Create(accountId, body).then(res => {
      assert.isObject(res)
    })
  })
  ...
  it('Delete a single account', () => {
    ...
    return ElasticPath.AccountMemberships.Delete(
      accountId,
      accountMembershipId
    ).then(res => {
      assert.isObject(res)
  ...
  it('Get all Account Memberships for an account using filter', () => {
    ...
    return ElasticPath.AccountMemberships.Filter({
      eq: {
